...
public class GmailLoginPage extends GmailBase{
	...
	public void invalidUserLogin(String email) throws Exception {
		System.out.println("Login is started");
		typeEmail(email);
		WebElement errorText =TestFunctions.waitUntilElementPresentInDOMWithXPATH(driver, userErrorPath, 180,"jsname", "B34EJ");
		TestFunctions.waitUntilTextPresent(errorText, "Couldn't find");
	...
	public void invalidPasswordLogin(String email, String password) throws Exception {
		...
		typeEmail(email);
		typePassword(password);
		WebElement errorText =TestFunctions.waitUntilElementPresentInDOMWithXPATH(driver, passwordErrorPath, 180,"jsname", "B34EJ");
		TestFunctions.waitUntilTextPresent(errorText, "Wrong password.");
	...
	public void typeEmail(String email) throws Exception {
		WebElement emailField =TestFunctions.waitUntilElementPresentInDOMWithCSS(driver, emailFieldPath, 180,"autocomplete", "username");
	...
	public void typePassword(String password) throws Exception {
		WebElement passwordField =TestFunctions.waitUntilElementPresentInDOMWithCSS(driver, passwordFieldPath, 500, "autocomplete", "current-password");
